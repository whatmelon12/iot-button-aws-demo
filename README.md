...
This is a sample template for iot_task_button - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name iot_task_button --tail
```
...
```bash
aws cloudformation delete-stack --stack-name iot_task_button
```
